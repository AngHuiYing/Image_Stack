...
<body>
    <div id="jumbotron" class="w-100 sticky-top py-4 px-5">
        <h1 class="text-center" id="app-title"><strong>Simple Image Sharing</strong></h1>
        <div id="app-description" class="py-2">Discover a Collection of Free Image.<br> All media on this site is sourced through the <b>pexels.com</b> API.</div>
